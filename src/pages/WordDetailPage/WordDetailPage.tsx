        ...
        {wordData && (
          <div className="rounded p-5 bg-white mt-5 border border-gray-300 w-3/5">
            ...
            <div className="flex flex-row">
              ...
              <span className="text-gray-500 text-lg">
                「{wordData?.sino_vietnamese.toUpperCase()}」
              </span>
            </div>
            <div className="mt-5">
              {wordData?.means.map((item, index) => (
                <div className="mt-5" key={index}>
                  <h3
                    key={index}
                    className="text-violet-500 text-lg font-semibold"
                  >
                    ◆ {item.meaning}
                  </h3>
                  <p className="text-red-500 text-lg mx-5 mt-2">
                    {item.example}
                  </p>
                  <p className="text-gray-500 text-lg mx-5">
        ...
        <div className="rounded p-5 bg-white my-5 border border-gray-300 w-3/5">
          <div>
            ...
            <div className="flex flex-row">
              ...
              />
              <textarea
                className="focus:ring-violet-500 focus:border-violet-500 border border-gray-300 rounded w-full h-20 ml-3 p-2"
