...
const Chapter = ({
  ...
  return (
    <div className="chapter min-w-min w-full h-auto min-h-[200px] border-solid border-2 border-gray-300 rounded-2xl flex flex-col justify-between items-center mt-2 mb-10 relative z-0">
